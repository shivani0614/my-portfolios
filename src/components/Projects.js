...
import covidMap from "../assets/img/covid-map.png";
  ...
  const projects = [
    {
      ...
      description: "Developed an engaging Movie Reviews web application utilizing AngularJS, offering users an interactive platform to browse, review, and rate movies. Utilized: JSON, Bootstrap, Angular CLI, Rest API’s, dynamic pages, Routing.",
      imgUrl: projImg1,
    },
    {
    ...
    },
    {
      ...
      description: "Implemented client-server architecture with RPC protocols, enabling seamless file actions such as uploading, deleting, and renaming, optimizing synchronous and asynchronous operations. Leveraged JAVA, VMware, and Ubuntu technologies.",
      imgUrl: projImg1,
    },
    {
